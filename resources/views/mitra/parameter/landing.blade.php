    ...
    <div class="container-xxl flex-grow-1 container-p-y ">
        <div class="card overflow-hidden pb-4">
            <div class="container-xl">
                ...
                <div class="row g-5">
                    <div class="col-lg-6 mx-auto align-self-start bg-label">
                        <div class="card-body text-center">
                            @if (request('dimensi') == 1)
                                <h3 class="mb-5 fw-bold card-title">{{ $dimensi->deskripsi }}</h3>
                                <i class='bx bx-donate-heart text-primary' style="font-size:200px"></i>
                            ...
                            @elseif (request('dimensi') == 2)
                                <h3 class="mb-5 fw-bold card-title">{{ $dimensi->deskripsi }}</h3>
                                <i class='bx bx-universal-access text-primary' style="font-size:200px"></i>
                                <figure class="text-center mt-2">
                                    <blockquote class="blockquote">
                                        <p class="mb-0">
                            ...
                            @elseif (request('dimensi') == 3)
                                <h3 class="mb-5 fw-bold card-title">{{ $dimensi->deskripsi }}</h3>
                                <i class='bx bx-shape-circle text-primary' style="font-size:200px"></i>
                                <figure class="text-center mt-2">
                                    <blockquote class="blockquote">
                                        <p class="mb-0">
                            ...
                            @elseif (request('dimensi') == 4)
                                <h3 class="mb-5 fw-bold card-title">{{ $dimensi->deskripsi }}</h3>
                                <i class='bx bx-shield-quarter text-primary' style="font-size:200px"></i>
                                <figure class="text-center mt-2">
                                    <blockquote class="blockquote">
                                        <p class="mb-0">
                            ...
                            @elseif (request('dimensi') == 5)
                                <h3 class="mb-5 fw-bold card-title">{{ $dimensi->deskripsi }}</h3>
                                <i class='bx bx-code-alt text-primary' style="font-size:200px"></i>
                                <figure class="text-center mt-2">
                                    <blockquote class="blockquote">
                                        <p class="mb-0">
                            ...
                            @if (auth()->user()->myprofile->role == 'mitra')
                                <a class="mt-2 btn btn-primary" href="{{ route('parameter.index') . '?dimensi=' . $dimensi->id . '&param=' . $dimensi->param->first()->id }}">Mulai</a>
                            @elseif (auth()->user()->myprofile->role == 'warga')
                                <a class="mt-2 btn btn-primary" href="{{ route('qa.index') . '?dimensi=' . $dimensi->id . '&param=' . $dimensi->param->first()->id }}">Mulai</a>
                            @endif
                        </div>
                    </div>
                    <div class="col-lg-5 border-start border-secondary">
                        <div class="card shadow-none bg-label-danger text-center">
                        ...
                        <div class="card shadow-none bg-label-warning text-center mt-3">
                            <div class="card-header pb-1 pt-2">
                        ...
                        <div class="card shadow-none bg-label-success text-center mt-3">
                            <div class="card-header pb-1 pt-2">
                        ...
                        <div class="card shadow-none bg-label-info text-center mt-3">
                            <div class="card-header pb-1 pt-2">
                        ...
                        <div class="card shadow-none bg-label-primary text-center mt-3">
                            <div class="card-header pb-1 pt-2">
